...
from routers import auth, contact, projects, services, stats, team, whitepapers
...
app.include_router(whitepapers.router)
...
def root():
    ...
    return {
        ...
        "endpoints": [
            ...
            "GET  /api/v1/whitepapers/search",
            "GET  /api/v1/whitepapers/{filename}",
        ],
    }
